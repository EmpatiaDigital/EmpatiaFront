...
// FRONTEND: Tu componente React modificado
import React, { useEffect, useState } from "react";
import { useParams } from "react-router-dom";
...
const PostCompleto = () => {
  ...
  // *** CAMBIO IMPORTANTE: URL para compartir ***
  const currentUrl = `https://empatia-back.vercel.app/preview/post/${id}`;
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta property="og:url" content={`https://empatia-front.vercel.app/post/${id}`} />
        <link rel="canonical" href={`https://empatia-front.vercel.app/post/${id}`} />
      </Helmet>
